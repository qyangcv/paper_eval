...
# 导入项目模块
try:
    from utils.eval.models.deepseek import request_deepseek
    from utils.eval.models.gemini import request_gemini
    from utils.eval.models.qwen import request_qwen
    from utils.eval.prompts.chapter_prompt import p_chapter_assessment
    from utils.eval.prompts.overall_prompt import p_overall_assessment
