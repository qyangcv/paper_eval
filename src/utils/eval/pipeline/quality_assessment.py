...
# 修改导入路径
try:
    from utils.eval.models import request_qwen, request_deepseek, request_gemini
    from utils.eval.prompts import p_wq_zh, p_wq_en, p_wq_col, p_wq_for, p_wq_ref, p_writing_quality
